...
** Last update Sun Jun 26 23:44:33 2016 Etienne Pasteur
*/
...
# define ForEach(list, el2mnt, pred) (list->forEachElements(list, lambda(void, (void *el2mnt, void *dat), pred), NULL))
