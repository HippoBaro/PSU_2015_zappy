...
static const struct s_request_invoke commands[] =
  {
    ...
    {ROTATE, (void *(*)(void *, Request *)) &Rotate,
     (void *(*)(void *, Request *)) &CanRotate},
    {LOOK, (void *(*)(void *, Request *)) &Look, NULL},
    {LOOK_INVENTORY, (void *(*)(void *, Request *)) &ListInventory, NULL},
    {TAKE, (void *(*)(void *, Request *)) &Take,
     (void *(*)(void *, Request *)) &CanTake},
    {DROP, (void *(*)(void *, Request *)) &Drop,
     (void *(*)(void *, Request *)) &CanDrop},
    {EXPULSE, (void *(*)(void *, Request *)) &Expulse,
     (void *(*)(void *, Request *)) &CanExpulse},
    {BROADCAST, (void *(*)(void *, Request *)) &Broadcast, NULL},
    {INCANT, (void *(*)(void *, Request *)) &Incant,
     (void *(*)(void *, Request *)) &CanIncant},
